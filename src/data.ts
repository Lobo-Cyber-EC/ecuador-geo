// Base de datos estática oficial de la División Política de Ecuador.
// Mantenida localmente para permitir actualizaciones manuales rápidas.
export const provinciasData: Record<
  string,
  {
    provincia?: string;
    lat?: number;
